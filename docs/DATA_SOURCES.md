...
The last successful WPC and Via snapshots remain queryable if a source is temporarily unavailable or changes shape. A GLEIF failure makes the Resolver abstain. Source absence, entity-resolution absence, and public-list absence are never converted into a licensing conclusion.
